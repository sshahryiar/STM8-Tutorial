...
#define OLED_port_1																	GPIOD		
#define OLED_port_2																	GPIOG		
...
#define SCL_pin																			D0_pin
#define SDA_pin																			D1_pin

#define SCL_OUT_HIGH()															GPIO_WriteHigh(OLED_port_1, SCL_pin)
#define SCL_OUT_LOW() 															GPIO_WriteLow(OLED_port_1, SCL_pin)

#define SDA_OUT_HIGH()															GPIO_WriteHigh(OLED_port_2, SDA_pin)
#define SDA_OUT_LOW() 															GPIO_WriteLow(OLED_port_2, SDA_pin)

#define RST_OUT_HIGH()															GPIO_WriteHigh(OLED_port_2, RST_pin)
#define RST_OUT_LOW() 															GPIO_WriteLow(OLED_port_2, RST_pin)

#define DC_OUT_HIGH()											   				   	GPIO_WriteHigh(OLED_port_2, DC_pin)
#define DC_OUT_LOW() 																GPIO_WriteLow(OLED_port_2, DC_pin)

#define CS_OUT_HIGH()																GPIO_WriteHigh(OLED_port_2, CS_pin)
#define CS_OUT_LOW() 																GPIO_WriteLow(OLED_port_2, CS_pin)
