...
{
	GPIO_DeInit(OLED_port_1);
	GPIO_Init(OLED_port_1, SCL_pin, GPIO_MODE_OUT_PP_LOW_FAST);
	
	GPIO_DeInit(OLED_port_2);
	GPIO_Init(OLED_port_2, ((GPIO_Pin_TypeDef)(SDA_pin | RST_pin | DC_pin | CS_pin)), GPIO_MODE_OUT_PP_LOW_FAST);
}
